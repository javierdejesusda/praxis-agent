...
export function Sparkline({
  ...
  if (data.length < 2) return <span className="text-[color:var(--color-muted-soft)] text-[10px]">—</span>;
  ...
  const resolvedTone =
    tone === "auto"
      ...
      : tone;
  const stroke =
    resolvedTone === "gain" ? colors.gain : resolvedTone === "loss" ? colors.loss : colors.muted;
  return (
